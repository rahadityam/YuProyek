                ...
                <tr class="hover:bg-gray-50 {{ $payslip->status == \App\Models\Payment::STATUS_DRAFT ? 'italic text-gray-600 opacity-90' : '' }}">
                    ...
                    <td class="px-4 py-4 whitespace-nowrap text-center text-sm font-medium">
                        ...
                        <div class="flex justify-center space-x-3">
                            ...
                            <a href="{{ route('projects.payslips.show', [$project, $payslip]) }}?print=1" target="_blank" rel="noopener noreferrer" class="text-gray-600 hover:text-gray-900" title="Print Slip Gaji">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
