{{-- resources/views/tasks/partials/_recap_table_content.blade.php --}}
<div class="overflow-x-auto">
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            @empty
                <tr><td colspan="10" class="text-center py-10 text-gray-500 italic">No tasks found matching your criteria.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>

{{-- Untuk Pagination, kita akan menggunakan delegasi event, jadi tidak perlu @click di sini --}}
@if ($tasks->hasPages())
