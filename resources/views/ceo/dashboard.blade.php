        ...
        <div class="flex">
            ...
            <div class="container mx-auto p-6">
                <div class="bg-white rounded-lg shadow-lg p-6 flex flex-col">
                    ...
                    <!-- Konten HTML Anda (tidak berubah, sudah benar) -->
                    ...
                    <div class="max-w-7xl mx-auto space-y-4 mb-6 w-full">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Total Projects</h2><p class="text-black text-2xl font-bold">{{ $totalProjects }}</p></div>
                                <div class="bg-blue-500 rounded-[6px] p-2"><i class="bi bi-folder-fill text-white text-2xl"></i></div>
                            </div>
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Projects Started</h2><p class="text-black text-2xl font-bold">{{ $totalProjectsStarted }}</p></div>
                                <div class="bg-green-500 rounded-[6px] p-2"><i class="bi bi-play-circle-fill text-white text-2xl"></i></div>
                            </div>
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Projects Ended</h2><p class="text-black text-2xl font-bold">{{ $totalProjectsEnded }}</p></div>
                                <div class="bg-red-500 rounded-[6px] p-2"><i class="bi bi-check2-circle text-white text-2xl"></i></div>
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Total Users</h2><p class="text-black text-2xl font-bold">{{ $totalUsers }}</p></div>
                                <div class="bg-gray-400 rounded-[6px] p-2"><i class="bi bi-people-fill text-white text-2xl"></i></div>
                            </div>
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Active Workers</h2><p class="text-black text-2xl font-bold">{{ $activeWorkersCount }}</p></div>
                                <div class="bg-green-500 rounded-[6px] p-2"><i class="bi bi-person-check-fill text-white text-2xl"></i></div>
                            </div>
                            <div class="bg-white rounded shadow p-4 flex justify-between items-start">
                                <div><h2 class="text-lg font-semibold text-gray-700">Inactive Workers</h2><p class="text-black text-2xl font-bold">{{ $inactiveWorkersCount }}</p></div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6 mb-6 max-w-7xl mx-auto w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <div class="border rounded-lg p-4 bg-gray-50">
                                ...
                                <div class="mb-1 flex justify-between text-xs text-gray-600"><span>{{ $project['completed_tasks'] }}/{{ $project['total_tasks'] }} selesai</span><span>{{ $project['progress_percent'] }}%</span></div>
                    ...
                    <!-- ========================================================== -->
                    <!-- == SCRIPT FINAL YANG TAHAN BANTING DAN BEBAS ERROR == -->
                    <!-- ========================================================== -->
                    <script>
                        ...
                        // Buat fungsi changeChart global agar bisa diakses dari HTML
                        ...
                        function initDashboardCharts() {
                            // SINTAKS DIPERBAIKI: Kurung kurawal {} yang salah dihapus
                            // DITAMBAH ?? [] untuk anti-error jika data dari controller null
                        ...
                        // Jalankan fungsi saat DOM dimuat dan saat Turbo/Livewire memuat ulang
