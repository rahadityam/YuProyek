<x-app-layout>
    <div x-data="{ showLoading: true }" class="container mx-auto px-4 py-8">
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-3xl font-bold">Daftar Proyek</h1>
            <!-- Tombol untuk membuat proyek baru dengan animasi Alpine.js -->
            <a href="{{ route('projects.create') }}" 
               class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded transition duration-200 ease-in-out"
               x-on:mouseenter="$el.classList.add('shadow-lg')" 
               x-on:mouseleave="$el.classList.remove('shadow-lg')">
