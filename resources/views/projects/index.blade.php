<x-app-layout>
    <div x-data="{ showLoading: true }" class="container mx-auto px-4 py-8">
        ...
        <form method="GET" action="{{ route('projects.index') }}" class="mb-8">
        ...
        <div x-show="!showLoading" x-transition:enter="transition ease-out duration-300" 
            ...
            @empty
                ...
                <div class="col-span-full bg-white rounded-xl shadow-md p-8 text-center">
                    ...
                    <h3 class="mt-3 text-lg font-medium text-gray-900">Tidak ada proyek</h3>
                    <p class="mt-2 text-gray-500">Mulai dengan membuat proyek baru</p>
                    <div class="mt-6">
